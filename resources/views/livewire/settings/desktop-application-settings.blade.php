                    ...
                    <div class="mb-6 flex flex-col md:flex-row gap-6">
                        ...
                        <div class="flex-1 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 flex flex-col justify-center">
                            <div class="flex flex-col items-center justify-center h-full text-center">
                                <div class="w-16 h-16 flex items-center justify-center mx-auto mb-3">
                                    <img src="{{ asset('img/icon.png') }}" alt="Hungry Hippo Desktop Printing App" class="w-14 h-14 object-contain">
                                </div>
                                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Hungry Hippo Desktop Printing App</h3>
                                <p class="text-xs text-gray-600 dark:text-gray-400">Download the official Hungry Hippo Desktop Printing App for direct printing</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex-1 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 flex flex-col justify-center">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">Watch how the desktop application works</p>
                            </div>
